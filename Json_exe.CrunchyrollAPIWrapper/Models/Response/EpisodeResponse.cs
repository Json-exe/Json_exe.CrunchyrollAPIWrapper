...
public record EpisodeResponse
{
    ...
    [JsonPropertyName("subtitle_locales")] public List<string> SubtitleLocales { get; } = [];
    ...
    [JsonPropertyName("maturity_ratings")] public List<string> MaturityRatings { get; } = [];

    [JsonPropertyName("is_dubbed")] public bool IsDubbed { get; set; }

    [JsonPropertyName("ad_breaks")] public List<AdBreak> AdBreaks { get; } = [];
    ...
    [JsonPropertyName("season_tags")] public List<object> SeasonTags { get; } = [];
